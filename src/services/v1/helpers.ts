...
const CRYGOCA_DATA_ENCRYPTION_KEY = new Uint8Array(
  Buffer.from(process.env.CRYGOCA_DATA_ENCRYPTION_KEY!, "hex")
);
...
export function encryptOnce(dataString: string): string {
  const iv = crypto.randomBytes(IV_LENGTH);
  const algorithm: crypto.CipherGCMTypes = "aes-256-gcm";
  const cipher = crypto.createCipheriv(
    algorithm,
    CRYGOCA_DATA_ENCRYPTION_KEY as unknown as Uint8Array,
    iv as Uint8Array
  );
...
export function decryptOnce(encryptedData: string): string {
...
export function encryptDataString(dataString: string, depth = 1): string {
...
export function decryptDataString(encryptedData: string, depth = 1): string {
...
export function getAddressFromPV() {
  // Given private key (64 chars, no 0x)
  const privateKey = decryptDataString(
    "cd0f69ca470a7ef759a1151828ada806:0edc6c13a3776e647c3e18e6c50813c1cecc0f8c5b25200658cfc58eb9cc1cf833de5201895b02f38eba6161b80a72e9a8137afb2f2a3de0e71835f5eb5d58836d39:024a3bc4a05c357c03e11a144c460a97",
    1
  );
  // With ethers:
