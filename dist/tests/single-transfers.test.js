...
const rollback_service_1 = require("../src/services/v1/wallet/rollback.service");
...
describe("Single transfer APIs Test", () => {
    ...
    it("Ensure if the database becomes unavailable during a transfer the tranfer details are stored in redis backup", () => __awaiter(void 0, void 0, void 0, function* () {
        (0, config_1.updateTestConfig)("DISCONNECT_DATABASE", "true");
        const transferPromise = new Promise((resolve) => {
            transferEmitter.once("transferComplete", (transferResponses) => {
                resolve(transferResponses);
            });
        ...
        const failedTransactionIds = (0, config_1.getTestConfig)().failedTransactionIds;
        for (let failedTransactionId of failedTransactionIds) {
            const failedTransaction = yield (0, rollback_service_1.getRollbackById)(failedTransactionId);
            logger_1.default.info(`failedTransaction===>${failedTransactionId} :== ${JSON.stringify(failedTransaction, null, 2)}`);
            expect(failedTransaction).not.toBeNull();
        }
        (0, config_1.updateTestConfig)("failedTransactionIds", []);
    }));
    it("Ensure transfer tasks pending in the redis database are completed immediately service is up", () => __awaiter(void 0, void 0, void 0, function* () { }));
});
