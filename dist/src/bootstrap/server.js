...
_app_1.default.get("/test-referal-code", async (req, res) => {
    const username = req.query.username;
    const referralCode = await (0, helpers_1.generateReferralCode)(username);
...
_app_1.default.get("/test-payment-verification-job", async (req, res) => {
    const jobData = {
