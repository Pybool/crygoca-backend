...
const authController = {
    ...
    sendPasswordResetOtp: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let status = 400;
            const authentication = new auth_service_1.Authentication(req);
            const result = yield authentication.sendPasswordResetOtp();
            status = 200;
    ...
    verifyPasswordResetOtp: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let status = 200;
            const authentication = new auth_service_1.Authentication(req);
            const result = yield authentication.verifyPasswordResetOtp();
            if (!result.status)
                status = 400;
            res.status(status).json(result);
        }
    ...
    checkUserName: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let status = 400;
            const authentication = new auth_service_1.Authentication(req);
            const result = yield authentication.checkUserName();
            status = 200;
            return res.status(status).json(result);
        }
        catch (error) {
    ...
    resendtwoFaLoginOtp: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let status = 400;
            const authentication = new auth_service_1.Authentication(req);
            const result = yield authentication.resendtwoFaLoginOtp();
            if (result)
                status = 200;
            res.status(status).json(result);
        }
    ...
    twofaSignInVerification: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let status = 400;
            const authentication = new auth_service_1.Authentication(req);
            const result = yield authentication.twofaSignInVerification();
            if (result)
                status = 200;
            res.status(status).json(result);
        }
    ...
    getUser: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let status = 400;
            const authentication = new auth_service_1.Authentication(req);
            const result = yield authentication.getUser();
            if (result)
                status = 200;
            res.status(status).json(result);
        }
