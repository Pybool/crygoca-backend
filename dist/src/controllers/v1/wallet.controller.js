...
exports.cardTopUpFundWallet = exports.walletGetBeneficiaries = exports.verifyWithdrawalOtp = exports.sendWithdrawalOtp = exports.verifyTransferOtp = exports.sendTransferOtp = exports.getReceipientWallet = exports.processWalletToBankWithdrawals = exports.processWalletTransfer = exports.createWallet = void 0;
...
const processWalletTransfer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const { debitDetails, creditDetails, sourceAmount, sourceCurrency, targetCurrency, saveBeneficiary, otp } = req.body;
    let amount = 0.0;
    try {
...
const getReceipientWallet = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const accountId = req.accountId;
        const walletResponse = yield wallet_service_1.WalletService.getReceipientWallet(walletId, accountId);
