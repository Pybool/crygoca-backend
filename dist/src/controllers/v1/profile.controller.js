...
exports.profileController = {
    ...
    _sendAddPasswordCode: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const accountId = req.accountId;
            const result = yield profile_service_1.ProfileService.sendAddPasswordCode(accountId);
            if (result.status) {
                res.status(200).json(result);
            }
            else {
    ...
    _addPassword: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { otp, newPassword, confirmPassword } = req.body;
            const accountId = req.accountId;
            const result = yield profile_service_1.ProfileService.addPassword(accountId, newPassword, confirmPassword, otp);
            if (result.status) {
                res.status(200).json(result);
            }
            else {
    ...
    _uploadAvatar: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let status = 400;
            const result = yield profile_service_1.ProfileService.uploadAvatar(req);
            if (result)
                status = 200;
