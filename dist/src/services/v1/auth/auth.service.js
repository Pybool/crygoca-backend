        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (error.message.includes("already exists!")) {
                    error.status = 200;
                    msg = (error === null || error === void 0 ? void 0 : error.message) || "User with email address already exists!";
                }
    ...
    sendEmailConfirmationOtp() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return mailservice_1.default.auth.sendEmailConfirmationOtp(user.email, otp);
            }
            catch (error) {
                console.log(error);
                throw error;
    ...
    resetPassword() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log(result, cachedToken === null || cachedToken === void 0 ? void 0 : cachedToken.code.toString(), result.token);
