...
class ProfileService {
    ...
    static uploadAvatar(req) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                let account = yield accounts_model_1.default.findOne({ _id: req.accountId });
                if (!account) {
                    return {
                        status: false,
                ...
                if (((_a = req === null || req === void 0 ? void 0 : req.attachments) === null || _a === void 0 ? void 0 : _a.length) > 0) {
