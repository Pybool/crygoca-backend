...
const checkIfListingIsDue = (listing) => {
    if (!(listing === null || listing === void 0 ? void 0 : listing.updatedAt))
        return ["no-action", '0'];
...
const timeoutAutoConfirmation = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const filter = {
        fulfillmentStatus: "Completed",
        buyerFulfillmentClaim: "Pending",
    };
    const CryptoListingPurchaseSchema = yield listingPurchase_model_1.default.find(filter).populate("account").populate("cryptoListing");
    for (let listing of CryptoListingPurchaseSchema) {
        ...
        if (state === "send-reminder") {
            ...
            const verifiedTransaction = yield verifiedtransactions_model_1.default.findOne({
                tx_ref: listing === null || listing === void 0 ? void 0 : listing.checkOutId,
            });
            if (verifiedTransaction) {
                ...
                const data = {
                    checkOutId: listing === null || listing === void 0 ? void 0 : listing.checkOutId,
                    ...
                    units: listing.units,
                    currency: (_b = (_a = listing.cryptoListing) === null || _a === void 0 ? void 0 : _a.currency) === null || _b === void 0 ? void 0 : _b.toUpperCase(),
            ...
            yield exports.timeoutAutoCompleteQueue.add("order-auto-completion", listing, {
                attempts: 2,
                backoff: 5000,
            });
        }
