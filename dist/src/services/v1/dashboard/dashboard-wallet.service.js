...
class DashboardWalletService {
    static fetchWalletTransactionData(accountId, operationType, timePeriod) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transactions = yield this.getTransactionsBetweenDates(accountId, operationType, startDate, endDate);
            // Process the data for visualization
            return this.groupTransactionsByPeriod(transactions, timePeriod);
        });
    }
    // Helper to fetch transactions from the database
    static getTransactionsBetweenDates(accountId, operationType, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static groupTransactionsByPeriod(transactions, timePeriod) {
        return __awaiter(this, void 0, void 0, function* () {
            const groupedData = {};
