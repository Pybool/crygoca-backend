...
function getUserCountry(req) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const countryCode = geoData === null || geoData === void 0 ? void 0 : geoData.country;
...
function convertCurrency(from, to, currencyFrom, currencyTo, amount) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const url = `https://api.currencyapi.com/v3/latest?apikey=${process.env.CURRENCYAPI_APP_ID ||
                "cur_live_d52M3q2XMNDurG4Q7kHtSr3P5iqTsNWpUtF5kcNx"}&base_currency=${data.currencyFrom}&currencies=${data.currencyTo}&amount=${data.amount}`;
            ...
            console.log("URL ", url);
            const cacheData = yield memCache.get(url);
            if (cacheData) {
