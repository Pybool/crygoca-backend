...
class WalletAuthorization {
    static sendTransferOtp(transferIntent) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (transferIntent) {
                    let debitWallet = yield wallet_service_1.WalletService.getReceipientWallet(transferIntent.walletToDebit);
                    let creditWallet = yield wallet_service_1.WalletService.getReceipientWallet(transferIntent.walletToCredit);
                    ...
                    if (clonedWallet.user.useTransferOtpEmail) {
                        mailservice_1.default.wallet.sendTransferConfirmationOtp(clonedWallet.user.email, Number(otp));
                    }
