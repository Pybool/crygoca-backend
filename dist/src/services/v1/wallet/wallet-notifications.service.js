...
class WalletNotificationService {
    static createCreditNotification(walletTransaction_1) {
        return __awaiter(this, arguments, void 0, function* (walletTransaction, isReversal = false) {
            ...
            mailservice_1.default.wallet.sendCreditAlertMail(user.email, { walletTransaction });
    ...
    static createDebitNotification(walletTransaction_1) {
        return __awaiter(this, arguments, void 0, function* (walletTransaction, isReversal = false) {
            ...
            mailservice_1.default.wallet.sendDebitAlertMail(user.email, { walletTransaction });
