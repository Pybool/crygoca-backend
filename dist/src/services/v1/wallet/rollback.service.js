    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if ((0, config_1.getTestConfig)().DISCONNECT_DATABASE === "true") {
                const ids = ((_a = (0, config_1.getTestConfig)()) === null || _a === void 0 ? void 0 : _a.failedTransactionIds) || [];
                ids.push(id);
                (0, config_1.updateTestConfig)("failedTransactionIds", ids);
            }
            ...
            for (const [id, actionData] of Object.entries(rollbackActions)) {
                ...
                try {
                    ...
                    if (rollback.actionType === "UPDATE-ONE") {
                        yield wallet_model_1.Wallet.updateOne(rollback.query, rollback.operation);
                    }
