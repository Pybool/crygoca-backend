...
profileRouter.get("/get-add-password-otp", jwt_1.decode, profile_controller_1.profileController._sendAddPasswordCode);
profileRouter.put("/add-password", jwt_1.decode, profile_controller_1.profileController._addPassword);
