...
flwRouter.post("/flw/payment/webhook", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (event.event === "charge.completed" &&
        ...
        const verificationResponse = yield flutterwave_service_1.FlutterWaveService.verifyCardPayment({
            paymentReference: event.data.id,
            expectedAmount: event.data.amount,
            expectedCurrency: (_a = event.data.currency) === null || _a === void 0 ? void 0 : _a.toUpperCase(),
