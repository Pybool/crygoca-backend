...
const decodeMerchant = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const reqHeaders = req.headers;
    if (!reqHeaders["authorization"]) {
        return res
            .status(400)
    ...
    try {
        ...
        const merchantAccount = yield accounts_merchant_model_1.default.findOne({ _id: req.merchantAccountId });
...
function updateLastSeen(accountId) {
    return __awaiter(this, void 0, void 0, function* () {
        yield accounts_model_1.default.findByIdAndUpdate(accountId, { lastSeen: new Date() });
    });
}
